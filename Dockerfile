...
WORKDIR /afrotd
RUN wget -nv https://afsvd.de/content/files/2024/12/Football_Regelbuch_2025.pdf
COPY . .
...
COPY --from=builder /afrotd/Football_Regelbuch_2025.pdf /afrotd/Football_Regelbuch_2025.pdf
COPY res ./res
EXPOSE 3000
